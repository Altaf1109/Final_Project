...
public partial class ElectronicAppliances : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                string strCon = ConfigurationManager.ConnectionStrings["MyCon"].ConnectionString;
                SqlConnection con = new SqlConnection(strCon);
                string strCmd = "insert into Electronics(Title,Description,Price,CatID,UserID,Dated) values('" + txtTitle.Text + "','" + txtDescription.Text + "'," + Price.Text + "," + 5 + ",'" + Session["UName"].ToString() + "','" + date + "')";
                SqlCommand cmd = new SqlCommand(strCmd, con);
                con.Open();
    ...
    private void Insert2()
    {
        ...
        if (FileUpload1.HasFile || FileUpload2.HasFile || FileUpload3.HasFile || FileUpload4.HasFile || FileUpload5.HasFile || FileUpload6.HasFile)
        {
            ...
            else
            {
                ...
                string strcmd0 = "SELECT TOP 1 * FROM Electronics ORDER BY EID DESC";
                ...
                string strCmd1 = "insert into ElectronicsInfo(PicPath1,PicPath2,PicPath3,PicPath4,PicPath5,PicPath6,Country,State,City,EID) values('" + strSaveName1 + "','" + strSaveName2 + "','" + strSaveName3 + "','" + strSaveName4 + "','" + strSaveName5 + "','" + strSaveName6 + "','" + Country.SelectedItem + "','" + State.SelectedItem + "','" + City.SelectedItem + "'," + id + ")";
