...
public partial class Mobile : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                string strCon = ConfigurationManager.ConnectionStrings["MyCon"].ConnectionString;
                SqlConnection con = new SqlConnection(strCon);
                string strCmd = "insert into Mobiles(Brand,Title,Description,Price,CatID,UserID,Dated) values('" + ddlBrand.SelectedValue + "','" + txtTitle.Text + "','" + txtDescription.Text + "'," + txtPrice.Text + "," + 3 + ",'" + Session["UName"] + "','" + date + "')";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string strcmd0 = "SELECT TOP 1 * FROM Mobiles ORDER BY MobID DESC";
            ...
            dtadp0.Fill(dt1);
            int id = Convert.ToInt32(dt1.Rows[0]["MobID"]);


            string strCon4 = ConfigurationManager.ConnectionStrings["MyCon"].ConnectionString;
            SqlConnection con4 = new SqlConnection(strCon4);
            string strCmd1 = "insert into MobileInfo(PicPath ,PicPath2,PicPath3,PicPath4,PicPath5,PicPath6,Country,State,City,MobID) values('" + strSaveName1 + "','" + strSaveName2 + "','" + strSaveName3 + "','" + strSaveName4 + "','" + strSaveName5 + "','" + strSaveName6 + "','" + Country.SelectedItem + "','" + State.SelectedItem + "','" + City.SelectedItem + "'," + id + ")";
    ...
    protected void Country_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        LoadStates();
        if (Country.SelectedItem.Text.ToString() == "India")
        {
            Label17.Text = "";
