...
public partial class Furnitures : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string strCon = ConfigurationManager.ConnectionStrings["MyCon"].ConnectionString;
            SqlConnection con = new SqlConnection(strCon);
            string strCmd = "insert into Furniture(Title,Description,Price,CatID,UserID,Dated) values('" + txtTitle.Text + "','" + txtDescription.Text + "'," + Price.Text + "," + 4 + ",'" + Session["UName"] + "','" + date + "')";
            SqlCommand cmd = new SqlCommand(strCmd, con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            ...
            string strcon0 = ConfigurationManager.ConnectionStrings["MyCon"].ConnectionString;
                ...
                string strcmd0 = "SELECT TOP 1 * FROM Furniture ORDER BY FuID DESC";
                ...
                dtadp0.Fill(dt1);
                int id = Convert.ToInt32(dt1.Rows[0]["FuID"]);


                string strCon4 = ConfigurationManager.ConnectionStrings["MyCon"].ConnectionString;
                SqlConnection con4 = new SqlConnection(strCon4);
                string strCmd1 = "insert into FurnitureInfo(PicPath1,PicPath2,PicPath3,PicPath4,PicPath5,PicPath6,Country,State,City,FID) values('" + strSaveName1 + "','" + strSaveName2 + "','" + strSaveName3 + "','" + strSaveName4 + "','" + strSaveName5 + "','" + strSaveName6 + "','" + Country.SelectedItem + "','" + State.SelectedItem + "','" + City.SelectedItem + "'," + id + ")";
